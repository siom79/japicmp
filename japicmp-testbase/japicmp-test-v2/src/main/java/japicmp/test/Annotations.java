...
public class Annotations {
	...
	@OuterAnnotation2(outer = { @InnerAnnotation2(inner = { @InnerInnerAnnotation(innerInner = { 2, 3 }, number = 42) }), @InnerAnnotation2(inner = { @InnerInnerAnnotation(innerInner = { 2, 3 }, number = 42), @InnerInnerAnnotation(innerInner = { 2, 3 }, number = 42) }) })
