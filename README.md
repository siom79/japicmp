...
``` bash
java -jar japicmp-0.17.0-jar-with-dependencies.jar -n new-version.jar -o old-version.jar
```
...
```
cd /tmp
git clone --branch japicmp-base-<verion> https://github.com/siom79/japicmp.git
cd japicmp
mvn site:site
mvn site:stage
