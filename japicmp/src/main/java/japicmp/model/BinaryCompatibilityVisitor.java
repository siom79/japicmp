...
public class BinaryCompatibilityVisitor implements ClassVisitor {
	private Map<String, JApiClass> classMap = new HashMap<>();
	...
	public void visit(JApiClass jApiClass) {
		classMap.put(jApiClass.getFullyQualifiedName(), jApiClass);
	}

	@Override
	public void postVisit() {
		for (JApiClass clazz : classMap.values()) {
