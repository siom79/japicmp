		...
		filter(jApiClasses, new FilterVisitor() {
			...
			public void visit(Iterator<JApiClass> iterator, JApiClass jApiClass) {
				...
				if (jApiClass.getChangeStatus() == JApiChangeStatus.MODIFIED) {
					if (jApiClass.getMethods().size() == 0 && jApiClass.getConstructors().size() == 0 && jApiClass.getInterfaces().size() == 0 && jApiClass.getFields().size() == 0 && jApiClass.getAnnotations().size() == 0
						&& jApiClass.getAbstractModifier().getChangeStatus() == JApiChangeStatus.UNCHANGED && jApiClass.getAccessModifier().getChangeStatus() == JApiChangeStatus.UNCHANGED && jApiClass.getFinalModifier().getChangeStatus() == JApiChangeStatus.UNCHANGED
						&& jApiClass.getStaticModifier().getChangeStatus() == JApiChangeStatus.UNCHANGED && jApiClass.getSuperclass().getChangeStatus() == JApiChangeStatus.UNCHANGED) {
						remove = true;
					}
