...
public class JApiCli {
    ...
    @Command(name = "compare", description = "Compares jars")
    public static class Compare implements Runnable {
        ...
        @Option(name = "-o", description = "Provides the path to the old version of the jar.")
        public String pathToOldVersionJar;

        @Option(name = "-n", description = "Provides the path to the new version of the jar.")
        public String pathToNewVersionJar;

        @Option(name = "-m", description = "Outputs only modified classes/methods. If not given, all classes and methods are printed.")
        ...
        @Option(name = "-i", description = "Comma separated list of package names to include, * can be used as wildcard.")
        public String packagesToInclude;

        @Option(name = "-e", description = "Comma separated list of package names to exclude, * can be used as wildcard.")
        public String packagesToExclude;

        @Option(name = "-x", description = "Provides the path to the xml output file. If not given, stdout is used.")
        ...
        public Options parse(String oldArchive, String newArchive, String xmlOutputFile, //
            ...
            String packagesExcludeArg) throws IllegalArgumentException {
